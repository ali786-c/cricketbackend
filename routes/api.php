...
use App\Http\Controllers\Api\V1\RuleProfileController;
...
Route::prefix('v1')->middleware('throttle:api')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'managed.owner'])->group(function () {
        ...
        Route::post('matches/{match}/result/submit', [ScoringController::class, 'submitResult'])->middleware(['permission:control draft', 'throttle:30,1'])->name('api.v1.matches.result.submit');
        ...
        Route::post('admin/matches/{match}/result/reject', [AdminResultController::class, 'reject'])->middleware(['permission:manage tournaments', 'throttle:30,1'])->name('api.v1.admin.matches.result.reject');
        Route::post('admin/matches/{match}/result/exception', [AdminResultController::class, 'exception'])->middleware(['permission:manage tournaments', 'throttle:30,1'])->name('api.v1.admin.matches.result.exception');
